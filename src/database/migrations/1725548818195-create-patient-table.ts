...
export class CreatePatientTable1725548818195 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."patient_payment_plan_enum" AS ENUM('AVULSA', 'MENSAL', 'BIMESTRAL', 'TRIMESTRAL')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f9e72506bb4b8ebbc6272fc674" ON "patient__comorbidities_comorbidity" ("patientId") `);
        await queryRunner.query(`CREATE INDEX "IDX_3be2de9917205d5fb0828469af" ON "patient__comorbidities_comorbidity" ("comorbidityId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "patient__comorbidities_comorbidity" DROP CONSTRAINT "FK_3be2de9917205d5fb0828469af9"`);
        await queryRunner.query(`ALTER TABLE "patient__comorbidities_comorbidity" DROP CONSTRAINT "FK_f9e72506bb4b8ebbc6272fc674b"`);
        await queryRunner.query(`ALTER TABLE "patient" DROP CONSTRAINT "FK_4cd40697b09aa74baffc280aa80"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3be2de9917205d5fb0828469af"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f9e72506bb4b8ebbc6272fc674"`);
