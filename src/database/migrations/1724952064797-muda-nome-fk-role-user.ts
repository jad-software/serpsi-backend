...
export class MudaNomeFkRoleUser1724952064797 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_58f65b84d6c98e9d539ccbda0b2" FOREIGN KEY ("Role_id") REFERENCES "role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_58f65b84d6c98e9d539ccbda0b2"`
    );
    await queryRunner.query(
