...
export class CreateSessionsTable1731450211975 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "meeting" ADD CONSTRAINT "FK_679f9a8464a33c12bd6f8ee225a" FOREIGN KEY ("Psychologist_id") REFERENCES "psychologist"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "document" ADD CONSTRAINT "FK_03a58091f1872824de7a5308e91" FOREIGN KEY ("Meeting_id") REFERENCES "meeting"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "document" DROP CONSTRAINT "FK_03a58091f1872824de7a5308e91"`);
        await queryRunner.query(`ALTER TABLE "meeting" DROP CONSTRAINT "FK_679f9a8464a33c12bd6f8ee225a"`);
        await queryRunner.query(`ALTER TABLE "meeting" DROP CONSTRAINT "FK_5d24b93ebc10553c9dba002d063"`);
