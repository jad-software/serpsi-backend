...
export class UpdateAddressComplementHomenumber1730984449142 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD "homeNumber" character varying NOT NULL DEFAULT '0000'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" DROP COLUMN "homeNumber"`);
        await queryRunner.query(`ALTER TABLE "address" ADD "homeNumber" integer NOT NULL`);
    }
